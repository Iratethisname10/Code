...
function Utility:getClosestCharacter(options)
    ...
    local mousePos = options.useFOV and getMouseLocation(UserInputService) or false
    local lastDistance, lastPlayer = math.huge, {}

    local maxFov = options.useFOV and options.aimbotFOV or math.huge
    local whitelistedPlayers = options.whitelistedPlayers or {} 
...
function Utility:getClosestCharacterWithEntityList(entityList, options)
    rayParams = options.rayParams or RaycastParams.new()
    rayParams.FilterDescendantsInstances = {}
    ...
    local mousePos = options.useFOV and getMouseLocation(UserInputService)
    local lastDistance, lastPlayer = math.huge, {}
    local whitelistedPlayers = options.whitelistedPlayers or {}
